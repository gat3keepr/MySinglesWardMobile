//
//  MSWCallingPreferenceViewController.m
//  MySinglesWard
//
...
#import "MSWCallingPreferenceViewController.h"
#import "MemberSurvey.h"
#import "JSONRequest.h"

@interface MSWCallingPreferenceViewController ()

@end

@implementation MSWCallingPreferenceViewController
...
- (IBAction)saveButtonPressed:(id)sender
{
    ...
    self.currentUser.survey.callingPref = self.inputView.text;
...
{
    self.inputView.text = self.currentUser.survey.callingPref;
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section 
{
    ...
    // Create label with section title
    UILabel *label = [[UILabel alloc] init];
    label.frame = CGRectMake(20, -1, 275, 30);
    label.backgroundColor = [UIColor clearColor];
    label.textColor = [UIColor blackColor];
    label.shadowColor = [UIColor lightTextColor];
    label.shadowOffset = CGSizeMake(0.0, 1.0);
